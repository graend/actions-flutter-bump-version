...
exports.loadYaml = exports.replaceVersionInfoAndSave = exports.incrementVersion = exports.saveYaml = exports.testBumpArgument = void 0;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const argOk = (0, exports.testBumpArgument)(bumpMe);
            if (!argOk) {
                (0, core_1.setFailed)('Invalid parameter supplied to bump, allowed values are major, minor, patch');
            }
...
const testBumpArgument = (arg) => {
    return ['major', 'minor', 'patch'].includes(arg);
};
exports.testBumpArgument = testBumpArgument;
const saveYaml = (yaml, path) => __awaiter(void 0, void 0, void 0, function* () {
    yield fs_1.promises.writeFile(path, (0, yaml_1.stringify)(yaml));
});
...
const replaceVersionInfoAndSave = (from, version, to) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield fs_1.promises.readFile(from, 'utf8');
    var result = data.replace(/version: [0-9]*\.[0-9]*\.[0-9]*\+[0-9]*/g, `version: ${versionInfoToString(version)}`);
    yield fs_1.promises.writeFile(to ? to : from, result);
});
exports.replaceVersionInfoAndSave = replaceVersionInfoAndSave;
const loadYaml = (path) => __awaiter(void 0, void 0, void 0, function* () {
    const pubspec = yield fs_1.promises.readFile(`${path}`, 'utf8');
    const pubspecYaml = (0, yaml_1.parse)(pubspec);
    return new yaml_1.Document(pubspecYaml);
});
...
const versionInfoToString = (version) => {
